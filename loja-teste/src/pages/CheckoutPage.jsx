...
function CheckoutPage({ carrinho, limparCarrinho }) {
  ...
  const finalizarPedido = (numeroGerado) => {
    ...
    localStorage.setItem("pedidos", JSON.stringify([...pedidosAnteriores, novoPedido]));
  };
  ...
  if (pedidoEnviado) {
    return (
      <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto" }}>
        ...
        <a href="/meus-pedidos">➡️ Ver meus pedidos</a>
      </div>
    );
  }
